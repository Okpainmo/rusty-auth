# Contributing to Rusty Auth

First off, thank you for considering contributing to this project! It's people like you that make
...
> And if you like the project, but just don't have time to contribute, that's fine too. There are
...
[Rust Auth Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this
...
[Issues](https://github.com/Okpainmo/rusty-auth/issues) that might help you. In case you have found
a suitable issue and still need clarification, you can write your question in this issue. It is also
advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the
following:

- Open an [Issue](https://github.com/Okpainmo/rusty-auth/issues/new).

- Provide as much context as you can about what you're running into.

- Provide project and platform versions (rustc, cargo, OS, etc), or a reproducible example if
  possible.
...
- To see if other users have experienced (and potentially already solved) the same issue you are
  ...
  [bug tracker](https://github.com/Okpainmo/rusty-auth/issues?q=label%3Abug).
...
> information to the issue tracker, or elsewhere in public. Instead, see [SECURITY.md](SECURITY.md).

We use GitHub issues to track bugs and errors. If you run into an issue with the project:

- Open an [Issue](https://github.com/Okpainmo/rusty-auth/issues/new). (Since we can't be sure at
  this point whether it is a bug or not, we ask you not to blanket-label the issue yet).
...
- If the team is able to reproduce the issue, it will be marked `confirmed`, as well as possibly
  other tags (such as `critical`), and the issue will be left to be
  [implemented by someone](#your-first-code-contribution).

### Suggesting Enhancements

This section guides you through submitting an enhancement suggestion for Rust Auth, including
completely new features and minor improvements to existing functionality. Following these steps
...
- Read the [Documentation](README.md) carefully and find out if the functionality is already
  covered, maybe by an individual configuration.

- Search [Issues](https://github.com/Okpainmo/rusty-auth/issues) to see if the enhancement has
...
[GitHub issues](https://github.com/Okpainmo/rusty-auth/issues).
...
- **Explain why this enhancement would be useful** to most Rust Auth users. You may also want to
...
Please follow the instruction in [README.md](README.md) for project prerequisites and environment
setup.

We use **Husky** and **Commitlint** to ensure high contribution standards. After cloning the repo,
make sure to run:
...
> All contributions must come from a branch named in this format: `<preferred_code_name>_dev` - all
> lowercase.
>
> E.g. `okpainmo_dev`
>
> We do not accept contributions from branches named in any other format. Furthermore, we prefer to
> not have contributors create multiple branches for every new contribution. A single branch created
> in the above format should serve conveniently for all contributions coming from each specific
> user.
...
We're always looking for help to improve our documentation! If you find a typo, or feel like a
section could be clearer, feel free to open a PR.
...
This project uses **Conventional Commits**. This is enforced by `Commitlint` and `Husky` during the
pre-commit phase.
